   ...
   protected:
    virtual void _activeTick() noexcept override {
      ...
      OpenCarbon::PVehicleEx::ForEachInstance([=](OpenCarbon::PVehicle* pvehicle) {
        ...
        switch (rnd) {
          case Mode::BopIt:
            rb->SetLinearVelocity(rb->GetLinearVelocity() + OpenCarbon::UMath::Vector3(0.0f, 0.0f, -60.0f));
            FMODWrapper::Get().PlaySoundFX(FMODWrapper::SoundFX::BopIt);
            break;
          case Mode::TwistIt:
            rb->SetAngularVelocity(rb->GetAngularVelocity() + OpenCarbon::UMath::Vector3(20.0f, 20.0f, 0.0f));
          ...
          case Mode::PullIt:
            ...
            break;
          case Mode::SpinIt:
            rb->SetAngularVelocity(rb->GetAngularVelocity() + OpenCarbon::UMath::Vector3(0.0f, 0.0f, 20.0f));
