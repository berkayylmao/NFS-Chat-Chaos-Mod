...
namespace Extensions::Game::MW05::Effects {
  class Chernobyl : public IGameEffect {
   ...
   protected:
    virtual bool _activate() noexcept override {
      ...
      if (!tod) return false;
      mBackup = OpenMW::TimeOfDayEx::Backup(tod);
      ...
      bool needs_backup = mBackupLighting.empty();
      OpenMW::TimeOfDayLightingEx::ForEach([&](OpenMW::Attrib::Collection* collection, OpenMW::Attrib::Layouts::timeofdaylightinglayout* layout) {
        if (needs_backup) mBackupLighting.push_back(OpenMW::TimeOfDayLightingEx::Backup(collection));
   ...
   public:
    explicit Chernobyl() : IGameEffect(8) {}
  };
}  // namespace Extensions::Game::MW05::Effects
