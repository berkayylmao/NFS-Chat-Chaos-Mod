...
namespace Extensions::Game::MW05::Effects {
  class PotatoPC : public IGameEffect {
   ...
   protected:
    ...
    virtual void _activeTick() noexcept override {
      ...
      if (work_time.count() < 150.0) {
        std::chrono::duration<double, std::milli> delta_ms(150.0 - work_time.count());
   ...
   public:
    explicit PotatoPC() : IGameEffect(21) {}
  };
}  // namespace Extensions::Game::MW05::Effects
