  ...
  class LookMaNoHands : public IGameEffect {
   protected:
    virtual bool _activate() noexcept override {
      Modifiers::InputModifier::Get().AddModifier(Modifiers::InputModifier::Modifier::IgnoreSteering);
      return true;
    }
    virtual bool _deactivate() noexcept override {
      Modifiers::InputModifier::Get().RemoveModifier(Modifiers::InputModifier::Modifier::IgnoreSteering);
      return true;
    }
