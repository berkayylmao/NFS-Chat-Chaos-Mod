...
namespace Extensions::Game::MW05::Effects {
  ...
  class WarpDrive : public IGameEffect {
    std::unique_ptr<MemoryEditor::Editor::DetourInfo> mDetourH;
    std::unique_ptr<MemoryEditor::Editor::DetourInfo> mDetourV;

   protected:
    virtual bool _activate() noexcept override {
      mDetourH = MemoryEditor::Get().Detour(0x6CF56C, reinterpret_cast<std::uintptr_t>(&details::WarpDrive::H::detour));
      mDetourV = MemoryEditor::Get().Detour(0x6CF57E, reinterpret_cast<std::uintptr_t>(&details::WarpDrive::V::detour));
      return true;
    }
    ...
    virtual void _activeTick() noexcept override {
      ...
      details::WarpDrive::H::sFactor = 1.0f;
   ...
   public:
    explicit WarpDrive() : IGameEffect(111), mDetourH(nullptr), mDetourV(nullptr) {}
  };
}  // namespace Extensions::Game::MW05::Effects
