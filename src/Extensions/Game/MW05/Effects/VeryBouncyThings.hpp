...
namespace Extensions::Game::MW05::Effects {
  class VeryBouncyThings : public IGameEffect {
   ...
   protected:
    virtual bool _activate() noexcept override {
      ...
      OpenMW::RigidBodySpecsEx::ForEach([&](OpenMW::Attrib::Collection* collection, OpenMW::Attrib::Layouts::rigidbodyspecslayout* layout) {
        ...
        layout->OBJ_ELASTICITY  = OpenMW::UMath::Vector4(7.5f, 7.5f, 7.5f, 15.0f);
        layout->WALL_ELASTICITY = OpenMW::UMath::Vector4(7.5f, 7.5f, 7.5f, 15.0f);
      });
   ...
   public:
    explicit VeryBouncyThings() : IGameEffect(127) {}
  };
}  // namespace Extensions::Game::MW05::Effects
