  ...
  class ThanosSnap : public IGameEffect {
   protected:
    virtual bool _activate() noexcept override {
      auto        count_pvehicles = OpenSpeed::MW05::PVehicle::GetInstancesCount();
      ...
      for (const auto& idx : idx_affected) {
        auto* pvehicle = OpenSpeed::MW05::PVehicle::GetInstance(idx) | OpenMW::PVehicleEx::ValidatePVehicle;
