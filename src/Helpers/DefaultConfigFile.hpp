...
namespace ChaosMod::DefaultConfigFile {
  constexpr char CONST_DEFAULT_CONFIG[] =
      ...
      "ConcernDoge\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":25,\"Duration\":40.0,\"IncompatibleWith\":[16]},"
      "{\"Name\":\"EARFQUAKE\",\"Description\":\"Shakes the ground, shakes the camera, shakes all the "
      ...
      "green\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":20,\"Duration\":60.0,\"IncompatibleWith\":[9]},{"
      "\"Name\":\"Rainbow Road\",\"Description\":\"Everyone likes some Mario Kart "
      "fun\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":9,\"Duration\":60.0,\"IncompatibleWith\":[8]},{\"Name\":"
      "\"Midnight Club Racing\",\"Description\":\"Removes all barriers and minimap during races and enables GPS for "
      ...
      "30KM/H\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":20,\"Duration\":10.0,\"IncompatibleWith\":[13,47]},{"
      ...
      "year\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":13,\"Duration\":5.0,\"IncompatibleWith\":[]},{\"Name\":"
      ...
      "good\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":3,\"Duration\":60.0,\"IncompatibleWith\":[]}]}";
}
