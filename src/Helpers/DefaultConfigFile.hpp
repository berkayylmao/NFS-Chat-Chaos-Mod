...
namespace ChaosMod::DefaultConfigFile {
  constexpr char CONST_DEFAULT_CONFIG[] =
      ...
      "speed)\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":10,\"Duration\":30.0,\"IncompatibleWith\":[14,47]},{"
      "\"Name\":\"School Zone\",\"Description\":\"Limits the speed of all cars to "
      "30KM/"
      "H\",\"IsEnabled\":true,\"IsStatusEffect\":false,\"NeedsActivationWarning\":false,\"Cooldown\":10,\"Duration\":30.0,\"IncompatibleWith\":[13,47]},{"
      ...
      "player)\",\"IsEnabled\":true,\"IsStatusEffect\":true,\"NeedsActivationWarning\":false,\"Cooldown\":5,\"Duration\":45.0,\"IncompatibleWith\":[59,60,68]}]"
      "}";
}
